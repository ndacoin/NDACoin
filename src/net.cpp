...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "NDACOIN " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"165.227.215.120", "165.227.215.120"},
    {"159.65.151.178", "159.65.151.178"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. NDACOIN is probably already running."), addrBind.ToString().c_str());
        else
